...
static uint8_t glyph_row(char c, int row)
{
    ...
    case 'A':
    {
        static const uint8_t g[7] = {14, 17, 17, 31, 17, 17, 17};
        return g[row];
    }
    case 'B':
    {
        static const uint8_t g[7] = {30, 17, 17, 30, 17, 17, 30};
        return g[row];
    }
    case 'C':
    {
        static const uint8_t g[7] = {14, 17, 16, 16, 16, 17, 14};
        return g[row];
    }
    case 'D':
    {
        static const uint8_t g[7] = {30, 17, 17, 17, 17, 17, 30};
        return g[row];
    }
    case 'E':
    {
        static const uint8_t g[7] = {31, 16, 16, 30, 16, 16, 31};
        return g[row];
    }
    case 'F':
    {
        static const uint8_t g[7] = {31, 16, 16, 30, 16, 16, 16};
        return g[row];
    }
    case 'G':
    {
    ...
    case 'H':
    {
        static const uint8_t g[7] = {17, 17, 17, 31, 17, 17, 17};
        return g[row];
    }
    case 'I':
    {
        static const uint8_t g[7] = {14, 4, 4, 4, 4, 4, 14};
        return g[row];
    }
    case 'J':
    {
        static const uint8_t g[7] = {7, 2, 2, 2, 18, 18, 12};
        return g[row];
    }
    case 'K':
    {
        static const uint8_t g[7] = {17, 18, 20, 24, 20, 18, 17};
        return g[row];
    }
    case 'L':
    {
        static const uint8_t g[7] = {16, 16, 16, 16, 16, 16, 31};
        return g[row];
    }
    case 'M':
    {
        static const uint8_t g[7] = {17, 27, 21, 21, 17, 17, 17};
        return g[row];
    }
    case 'N':
    {
        static const uint8_t g[7] = {17, 25, 21, 19, 17, 17, 17};
        return g[row];
    }
    case 'O':
    {
        static const uint8_t g[7] = {14, 17, 17, 17, 17, 17, 14};
        return g[row];
    }
    case 'P':
    {
        static const uint8_t g[7] = {30, 17, 17, 30, 16, 16, 16};
        return g[row];
    }
    case 'Q':
    {
        static const uint8_t g[7] = {14, 17, 17, 17, 21, 18, 13};
        return g[row];
    }
    case 'R':
    {
        static const uint8_t g[7] = {30, 17, 17, 30, 20, 18, 17};
        return g[row];
    }
    case 'S':
    {
        static const uint8_t g[7] = {15, 16, 16, 14, 1, 1, 30};
        return g[row];
    }
    case 'T':
    {
        static const uint8_t g[7] = {31, 4, 4, 4, 4, 4, 4};
        return g[row];
    }
    case 'U':
    {
        static const uint8_t g[7] = {17, 17, 17, 17, 17, 17, 14};
        return g[row];
    }
    case 'V':
    {
        static const uint8_t g[7] = {17, 17, 17, 17, 17, 10, 4};
        return g[row];
    }
    case 'W':
    {
        static const uint8_t g[7] = {17, 17, 17, 21, 21, 21, 10};
        return g[row];
    }
    case 'X':
    {
        static const uint8_t g[7] = {17, 17, 10, 4, 10, 17, 17};
        return g[row];
    }
    case 'Y':
    {
        static const uint8_t g[7] = {17, 17, 10, 4, 4, 4, 4};
        return g[row];
    }
    case 'Z':
    {
        static const uint8_t g[7] = {31, 1, 2, 4, 8, 16, 31};
        return g[row];
    }
    case ':':
    {
    ...
    case '.':
    {
        static const uint8_t g[7] = {0, 0, 0, 0, 0, 6, 6};
        return g[row];
    }
    case '/':
    {
    ...
    case '=':
    {
        static const uint8_t g[7] = {0, 31, 0, 31, 0, 0, 0};
        return g[row];
    }
    case '?':
    {
    ...
    case '<':
    {
        static const uint8_t g[7] = {2, 4, 8, 16, 8, 4, 2};
        return g[row];
    }
    case '>':
    {
        static const uint8_t g[7] = {8, 4, 2, 1, 2, 4, 8};
        return g[row];
    }
    case '!':
    {
    ...
    default:
    {
        static const uint8_t g[7] = {31, 17, 21, 21, 21, 17, 31};
        return g[row];
    }
    }
}
...
static void draw_char(ANativeWindow_Buffer *b, int x, int y, char c, int scale, uint32_t color)
{
    for (int row = 0; row < 7; ++row)
    {
        ...
        for (int col = 0; col < 5; ++col)
            if (bits & (1u << (4 - col)))
                fill_rect(b, x + col * scale, y + row * scale, scale, scale, color);
    }
}
...
{
    char b[8192];
    if (read_small("/proc/self/status", b, (int)sizeof(b)) <= 0)
        return -1;
    char *p = strstr(b, key);
    if (!p)
        return -1;
...
static int approx_fd_count(void)
{
    ...
    for (int i = 0; i < 512; ++i)
    {
        ...
        if (readlink_small(p, v, sizeof(v)) >= 0)
            ++n;
    }
    return n;
}
...
{
    if (!activity || !activity->env || !activity->clazz)
        return;
    JNIEnv *env = activity->env;
    jclass cls = (*env)->GetObjectClass(env, activity->clazz);
    jmethodID mid = cls ? (*env)->GetMethodID(env, cls, "moveTaskToBack", "(Z)Z") : 0;
    if (mid)
        (void)(*env)->CallBooleanMethod(env, activity->clazz, mid, JNI_TRUE);
    if ((*env)->ExceptionCheck(env))
        (*env)->ExceptionClear(env);
    if (cls)
        (*env)->DeleteLocalRef(env, cls);
...
{
    if (!g_activity || !g_activity->vm || !g_activity->clazz || !text)
        return -1;
    JNIEnv *env = 0;
    int attached = 0;
    ...
    if (ge != JNI_OK)
    {
        if ((*vm)->AttachCurrentThread(vm, (void **)&env, 0) != JNI_OK || !env)
            return -2;
        attached = 1;
    }
    ...
    if (set_clip && clip)
        (*env)->CallVoidMethod(env, clipboard, set_clip, clip);
    else
        rc = -3;
    ...
    if (clipboard_cls)
        (*env)->DeleteLocalRef(env, clipboard_cls);
    if (clipboard)
...
static void trust_draw_action(ANativeWindow_Buffer *b, int x, int y, int w, int h, const char *label, int rect[4], int scale, int danger)
{
    if (!b)
        return;
    uint32_t accent = danger ? rgb(255, 105, 120) : rgb(80, 220, 155), panel = rgb(17, 35, 34);
...
static void render_trust(ANativeWindow_Buffer *b, int *y, int x, int scale)
{
    ...
    snprintf(v, sizeof(v), "%s", locked ? "LOCKED / DEVICE TRUST STAYS" : "UNLOCKED / OWNER PROOFS ENABLED");
    kv(b, y, x, "USER PRESENCE", v, locked ? 0 : 1, scale);
    kv(b, y, x, "POLICY", g_trust_policy, g_trust_state == 3 ? 1 : 0, scale);
    snprintf(v, sizeof(v), "ZOWNER/1 / %u PROOFS", g_trust_proof_count);
    kv(b, y, x, "PROOF BROKER", v, g_trust_state == 3 ? 1 : 0, scale);
    ...
    int paired = trust_pref_get("trusted_host_pub", saved, sizeof(saved)) > 0;
    kv(b, y, x, "PAIRED HOST", paired ? "YES" : "NO", paired ? 1 : 0, scale);
    ...
    if (b)
    {
        int gap = 8, w = (b->width - x - 18 - gap) / 2, h = 28 * scale;
        if (w < 80)
            w = 80;
        trust_draw_action(b, x, *y, w, h, g_trust_state == 1 ? "APPROVE HOST" : "APPROVE", g_trust_approve_rect, scale, 0);
        trust_draw_action(b, x + w + gap, *y, w, h, "FORGET HOST", g_trust_forget_rect, scale, 1);
        *y += h + 8;
    }
}
...
static void render_system(ANativeWindow_Buffer *b, int *y, int x, int scale)
{
    ...
    if (prop_get("ro.build.version.release", v, sizeof(v)))
        kv(b, y, x, "ANDROID", v, 1, scale);
    if (prop_get("ro.build.type", v, sizeof(v)))
        kv(b, y, x, "BUILD TYPE", v, mini_streq(v, "user") ? 1 : 0, scale);
    ...
    if (prop_get("ro.product.cpu.abi", v2, sizeof(v2)))
        kv(b, y, x, "PRIMARY ABI", v2, 1, scale);
}
...
static void render_process(ANativeWindow_Buffer *b, int *y, int x, int scale)
{
    ...
    if (extract_status("Threads:", v, sizeof(v)) >= 0)
        kv(b, y, x, "THREADS", v, 1, scale);
    if (extract_status("VmRSS:", v, sizeof(v)) >= 0)
        kv(b, y, x, "RSS", v, 1, scale);
    if (extract_status("VmSize:", v, sizeof(v)) >= 0)
        kv(b, y, x, "VM SIZE", v, 1, scale);
    if (extract_status("TracerPid:", v, sizeof(v)) >= 0)
        kv(b, y, x, "TRACER PID", v, mini_streq(v, "0") ? 1 : -1, scale);
    if (extract_status("Seccomp:", v, sizeof(v)) >= 0)
        kv(b, y, x, "SECCOMP", v, mini_streq(v, "2") ? 1 : 0, scale);
    if (extract_status("NoNewPrivs:", v, sizeof(v)) >= 0)
        kv(b, y, x, "NO NEW PRIV", v, mini_streq(v, "1") ? 1 : 0, scale);
    if (extract_status("CapEff:", v, sizeof(v)) >= 0)
        kv(b, y, x, "CAP EFF", v, mini_streq(v, "0000000000000000") ? 1 : 0, scale);
    ...
    if (readlink_small("/proc/self/exe", v, sizeof(v)) >= 0)
        kv(b, y, x, "EXECUTABLE", v, 1, scale);
    if (readlink_small("/proc/self/ns/user", v, sizeof(v)) >= 0)
        kv(b, y, x, "NS USER", v, 1, scale);
}
...
static int bridge_token_from_intent(void)
{
    ...
    if (!g_activity || !g_activity->env || !g_activity->clazz)
        return -1;
    ...
    if (strlen(g_bridge_token) < 16)
    {
        ...
        if (pref_key)
            (*env)->DeleteLocalRef(env, pref_key);
        if (prefs_cls)
            (*env)->DeleteLocalRef(env, prefs_cls);
        if (prefs)
...
{
    if (g_bridge_token_saved || strlen(g_bridge_token) < 16 || !g_activity || !g_activity->vm || !g_activity->clazz)
        return 0;
    JNIEnv *env = 0;
    int attached = 0;
    JavaVM *vm = g_activity->vm;
    ...
    if (editor_cls)
        (*env)->DeleteLocalRef(env, editor_cls);
    if (editor)
...
static int bridge_request(const char *command, char *out, int cap)
{
    ...
    char wire[384];
    if (mini_streq(command, "HELLO"))
        snprintf(wire, sizeof(wire), "HELLO\n");
    else
    {
    ...
    if (pos <= 0)
        return e ? e : -4;
    if (strstr(out, "ERR auth-required-or-failed"))
        return 403;
    return 0;
}
...
{
    if (!g_core_class)
        g_core_class = AIBinder_Class_define(
...
static int core_prepare(AIBinder *core, AParcel **in)
{
    ...
    if (!clazz || !AIBinder_associateClass(core, clazz))
        return -1001;
...
static int core_read_status(AParcel *reply, char *err, int errcap)
{
    ...
    {
        if (err)
            snprintf(err, (size_t)errcap, "STATUS_HEADER %d", rc);
        return rc;
    }
    if (!status)
    {
        if (err)
            snprintf(err, (size_t)errcap, "NO STATUS");
        return -1002;
    }
    if (!AStatus_isOk(status))
    {
        ...
        if (err)
            snprintf(err, (size_t)errcap, "AIDL ERROR %d %s", st, msg ? msg : "");
...
static int core_call_string(AIBinder *core, uint32_t code, char *out, int cap)
{
    ...
    struct core_string_alloc a = {out, cap};
    out[0] = 0;
    rc = AParcel_readString(reply, &a, core_string_allocator);
    AParcel_delete(reply);
    if (rc != 0)
        snprintf(out, (size_t)cap, "READ %d", rc);
    return rc;
}
...
static int core_call_i32(AIBinder *core, uint32_t code, int32_t *value)
{
    ...
    rc = core_read_status(reply, err, sizeof(err));
    if (rc == 0)
        rc = AParcel_readInt32(reply, value);
    AParcel_delete(reply);
    return rc;
}
static int core_call_i64(AIBinder *core, uint32_t code, int64_t *value)
{
    ...
    rc = core_read_status(reply, err, sizeof(err));
    if (rc == 0)
        rc = AParcel_readInt64(reply, value);
    AParcel_delete(reply);
    return rc;
}
...
static int core_call_policy(AIBinder *core, const char *principal, const char *action, const char *resource, char *out, int cap)
{
    ...
    if (rc == 0)
        rc = AParcel_writeString(in, action, (int32_t)strlen(action));
    if (rc == 0)
        rc = AParcel_writeString(in, resource, (int32_t)strlen(resource));
    if (rc != 0)
    {
        AParcel_delete(in);
...
static void render_core(ANativeWindow_Buffer *b, int *y, int x, int scale)
{
    ...
    if (core)
    {
        ...
        kv(b, y, x, "DEVICE CORE", "NOT INSTALLED / NOT VISIBLE", 0, scale);
    ...
    if (core)
        AIBinder_decStrong(core);

    int hello = bridge_request("HELLO", v, sizeof(v));
    if (hello == 0)
        kv(b, y, x, "ADB BRIDGE", v, 1, scale);
    else
    {
    ...
    if (bridge_ok)
    {
        ...
        bridge_field(status, "context", ctx, sizeof(ctx));
        if (extract_status("Seccomp:", appsec, sizeof(appsec)) < 0)
            snprintf(appsec, sizeof(appsec), "?");
        ...
        if (!core_ok)
            kv(b, y, x, "ACTIVE MODE", "ADB SHELL CORE / AUTH LOOPBACK", 1, scale);
    }
    else if (core_ok)
        kv(b, y, x, "ACTIVE MODE", "SYSTEM DEVICE CORE / BINDER", 1, scale);
    else
        kv(b, y, x, "ACTIVE MODE", "APPLICATION SANDBOX", 0, scale);
...
static void render_binder(ANativeWindow_Buffer *b, int *y, int x, int scale)
{
    ...
    if (fd >= 0)
    {
        ...
        kv(b, y, x, "VERSION IOCTL", "SKIPPED", -1, scale);
    ...
    for (int i = 0; i < KNOWN_SERVICE_COUNT; ++i)
    {
        ...
        if (svc)
        {
            ...
            kv(b, y, x, g_known_services[i], "NOT VISIBLE", 0, scale);
    }
...
static void render_network(ANativeWindow_Buffer *b, int *y, int x, int scale)
{
    ...
    if (n >= 2)
        snprintf(v, sizeof(v), "%d", n - 2);
    else
        snprintf(v, sizeof(v), "DENIED ERRNO %d", e);
    kv(b, y, x, "INTERFACES", v, n >= 2 ? 1 : 0, scale);
    n = count_file_lines_ex("/proc/net/route", &e);
    if (n >= 1)
        snprintf(v, sizeof(v), "%d", n - 1);
    else
        snprintf(v, sizeof(v), "DENIED ERRNO %d", e);
    ...
    if (prop_get("net.dns1", v, sizeof(v)))
        kv(b, y, x, "DNS PROP", v, 1, scale);
    else
        kv(b, y, x, "DNS PROP", "NOT EXPOSED", 0, scale);
...
static void render_security(ANativeWindow_Buffer *b, int *y, int x, int scale)
{
    ...
    if (prop_get("ro.boot.verifiedbootstate", v, sizeof(v)))
        kv(b, y, x, "VERIFIED BOOT", v, mini_streq(v, "green") ? 1 : 0, scale);
    else
        kv(b, y, x, "VERIFIED BOOT", "NOT EXPOSED", 0, scale);
    if (prop_get("ro.boot.vbmeta.device_state", v, sizeof(v)))
        kv(b, y, x, "VBMETA STATE", v, mini_streq(v, "locked") ? 1 : 0, scale);
    if (prop_get("ro.boot.flash.locked", v, sizeof(v)))
        kv(b, y, x, "FLASH LOCK", v, mini_streq(v, "1") ? 1 : 0, scale);
    if (prop_get("ro.debuggable", v, sizeof(v)))
        kv(b, y, x, "DEBUGGABLE", v, mini_streq(v, "0") ? 1 : 0, scale);
    if (prop_get("ro.secure", v, sizeof(v)))
        kv(b, y, x, "RO SECURE", v, mini_streq(v, "1") ? 1 : 0, scale);
    if (extract_status("TracerPid:", v, sizeof(v)) >= 0)
        kv(b, y, x, "TRACER PID", v, mini_streq(v, "0") ? 1 : -1, scale);
    if (extract_status("Seccomp:", v, sizeof(v)) >= 0)
        kv(b, y, x, "SECCOMP", v, mini_streq(v, "2") ? 1 : 0, scale);
...
static void render(void)
{
    ...
    char header[128];
    snprintf(header, sizeof(header), "V0.2.2 / DEVICE TRUST / USER PRESENCE / ZTRUST2 / NO DEX");
    y += 11 * title_scale;
    ...
    cy += 15 * scale;
    if (g_selected_tab == 0)
        render_system(&b, &cy, cx, scale);
    else if (g_selected_tab == 1)
        render_process(&b, &cy, cx, scale);
    else if (g_selected_tab == 2)
        render_trust(&b, &cy, cx, scale);
    else if (g_selected_tab == 3)
        render_core(&b, &cy, cx, scale);
    else if (g_selected_tab == 4)
        render_binder(&b, &cy, cx, scale);
    else if (g_selected_tab == 5)
        render_network(&b, &cy, cx, scale);
    else if (g_selected_tab == 6)
        render_security(&b, &cy, cx, scale);
    else if (g_selected_tab == 7)
        render_native(&b, &cy, cx, scale);
    else
        render_sandbox(&b, &cy, cx, scale);

    int foot = b.height - 38 * scale;
    if (foot > cy + 10)
        draw_text(&b, cx, foot, "TRUST = OWNER IDENTITY + PROOF BROKER. LAB TABS REMAIN READ-ONLY.", scale, dim);
...
static void handle_touch(int x, int y)
{
    ...
    if (g_selected_tab == 2 && in_rect(x, y, g_trust_approve_rect))
    {
        if (g_trust_state == 1)
        {
            g_trust_approve_requested = 1;
            snprintf(g_trust_status, sizeof(g_trust_status), "APPROVED - RETRYING");
        }
        ++g_run_counter;
        render();
        return;
    ...
    if (in_rect(x, y, g_copy_rect))
    {
        ...
        if (rc == 0)
            snprintf(g_copy_status, sizeof(g_copy_status), "COPIED %d B", g_report_len);
        else
            snprintf(g_copy_status, sizeof(g_copy_status), "COPY ERR %d", rc);
        render();
        return;
    }
}
...
__attribute__((visibility("default"))) void ANativeActivity_onCreate(ANativeActivity *activity, void *savedState, size_t savedStateSize)
{
    ...
    if (headless)
        move_activity_to_back(activity);
    if (trust_intent_autoconnect())
        g_selected_tab = 2;
    g_running = 1;
    g_ui_alive = 1;
    ...
    pthread_t t;
    if (pthread_create(&t, 0, input_thread, (void *)(unsigned long)ui_generation) == 0)
        pthread_detach(t);
}
