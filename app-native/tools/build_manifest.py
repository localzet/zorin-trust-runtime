...
strings = [x[0] for x in RESOURCE_ATTRS] + [
    ...
    "dev.zorin.trustruntime", "5.0.1", "Zorin Trust Runtime",
...
def build():
    ...
    c += [
      start_tag('manifest', [('package','dev.zorin.trustruntime',False,'string'),('versionCode',51,True,'int'),('versionName','5.0.1',True,'string')],2),
