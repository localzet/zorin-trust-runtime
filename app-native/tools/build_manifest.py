...
strings = [x[0] for x in RESOURCE_ATTRS] + [
    ...
    "dev.zorin.trustruntime", "8.0.0", "Zorin Trust",
    ":trust",
...
def build():
    ...
    c += [
      start_tag('manifest', [('package','dev.zorin.trustruntime',False,'string'),('versionCode',80,True,'int'),('versionName','8.0.0',True,'string')],2),
