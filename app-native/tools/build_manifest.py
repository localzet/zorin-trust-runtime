...
strings = [x[0] for x in RESOURCE_ATTRS] + [
    ...
    "dev.zorin.trustruntime", "5.0.0", "Zorin Trust Runtime",
...
def build():
    ...
    c += [
      start_tag('manifest', [('package','dev.zorin.trustruntime',False,'string'),('versionCode',50,True,'int'),('versionName','5.0.0',True,'string')],2),
