...
strings = [x[0] for x in RESOURCE_ATTRS] + [
    ...
    "dev.zorin.trustruntime", "8.1.0", "Zorin Trust",
    ":trust",
...
def build():
    ...
    c += [
      start_tag('manifest', [('package','dev.zorin.trustruntime',False,'string'),('versionCode',81,True,'int'),('versionName','8.1.0',True,'string')],2),
